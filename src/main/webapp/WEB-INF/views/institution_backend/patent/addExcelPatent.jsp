		...
		<div class="container">
			...
			<div class="ins_backend_rightContent">
				<ul class="nav nav-tabs">
					<jsp:include page="../../commonPatentBackend.jsp"><jsp:param name="activeItem" value="addPatent" /> </jsp:include>
				</ul>
...
<script type="text/javascript">
	$(document).ready(function(){
	    var uploader = new qq.FileUploader({
	        ...
	        action: "<dhome:url value='/institution/${domain}/backend/patent?func=uploadExceltex'/>",
