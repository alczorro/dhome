...
public interface IInstitutionPublicationDAO {
	List<InstitutionPublication> all();

	int create(InstitutionPublication pub);
	...
	int insert(String pubName);
	
	InstitutionPublication getIdByName(String pubName);
