...
<%-- 					    <a href="<dhome:url value='/people/${domain}/admin/commonPaper'/>" class="float-right"><i class="icon icon-edit abs-top"></i><span class="common-link">编辑</span></a></h3> --%>
					</div>
					        		...
					        		<c:choose>
						        		...
						        		<c:otherwise>
						        			<span>
								        		...
								        		<%-- <div class="upload-fulltext maintain" style="margin-top:3px;" >
