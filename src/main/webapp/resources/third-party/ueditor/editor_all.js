/**
 * edit by lvly@2013-1-8 因为工具栏被banner遮盖，所以就改了一些,请用时间查询修改处
 * 
 * */
 ...
 */
    UE.plugins['autofloat'] = function() {
		...
		function setFloating(){
			//add by lvly@2013-1-8  if autoFloat please release NextLine
			...
			if (LteIE6 || quirks) {
                ...
                if(toolbarBox.style.position != 'fixed'){
                 ...
                 // if autoFloat please delete next line
                    // remove by lvly@2013-1-8 toolbarBox.style.top = '0';
        ...
        function updateFloating(){
            ...
            //edit by lvly@2013-1-8 0改为40px
            if (rect3.top < 0 && rect3.bottom - toolbarBox.offsetHeight > 40) {
                setFloating();
            }else{
                unsetFloating();
            }
