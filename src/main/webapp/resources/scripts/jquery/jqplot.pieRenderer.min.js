		...
		for (var W = 0; W < z.length; W++) {
			...
			if (this.showDataLabels && z[W][2] * 100 >= this.dataLabelThreshold) {
				...
				if (this.dataLabels == "label") {
					...
					if(this.dataLabels == "both"){
						F = this.dataLabelFormatString || "%d%%(%d)";
						T = e.jqplot.sprintf(F, z[W][2] * 100,this.data[W][1])
					}else{
				...
				var u = e(
						'<div class="jqplot-pie-series jqplot-data-label" style="position:absolute;color:#FFFFFF;font-size:6px;">'
								+ T + "</div>").insertBefore(
						o.eventCanvas._elem);
