		...
		<div class="row-fluid mini-layout center p-top">
			...
			<div class="span9 left-b">
				<div class="ins_backend_rightContent">
					<jsp:include page="../../commonTraining.jsp"><jsp:param name="activeItem" value="modifyTraining" /> </jsp:include>
...
<!-- 									<option value="0">--</option> -->
			       		...
			       		<div class="control-group">
			       			<label class="control-label"><span class="red">*</span>导师：</label>
...
<%-- 								<span id="userNameSpan" class="alert" style="padding:3px" data-uid="${training.umtId }"> --%>
...
<!-- 								<span class="error" id="authorError"></span> -->
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls padding">
			       				${deptMap[member.departId].shortName }
						...
						<div class="control-group">
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls">
			         			...
			         			<a class="btn btn-link" href="<dhome:url value="/people/${domain }/admin/training/list/1"/>">取消</a>
			       			</div>
			       		</div>
					</form>
				</div>	
...
// 			//token控件初始化，关键字
// 			var $tokenObj = $("#keywordDisplay").tokenInput("<dhome:url value='/people/${domain}/admin/training/search/keyword'/>", {
// 				theme:"facebook",
// 				hintText: "请输入关键字",
// 				searchingText: "正在查询...",
...
// 			})(15,parseInt('${training.enrollmentDate}.getFullYear()'));
			...
			})(15,parseInt(parseDate('${training.enrollmentDate}').getFullYear()),parseInt(parseDate('${training.graduationDate}').getFullYear())); 
...
// 					data +='&umtId='+umtId;
					$.ajax({
	 					  type: 'POST',
	 					  url: '<dhome:url value="/people/${domain}/admin/training/submit"/>',
	 					  data: data,
	 					  success: function(data){window.location.href='<dhome:url value="/people/${domain}/admin/training/list/${empty returnPage?1:returnPage}"/>'},
	 					  error:function(){alert(data.desc)},
	 					  dataType: "JSON"
	 					});
// 					$.post('<dhome:url value="/people/${domain}/admin/training/submit"/>',data).done(function(data){ 
// 						if(data.success){
// 							alert();
// 							window.location.href='<dhome:url value="/people/${domain}/admin/training/list/${returnPage}"/>'
// 						}
//						else{
// 							alert(data.desc);
// 						}
