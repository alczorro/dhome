...
public interface IInstitutionBackendTopicAuthorDAO {
	List<InstitutionAuthor> getAuthorListByTopicId(int topicId);
	List<InstitutionAuthor> getAuthorListByTopicIds(List<Integer> topicIds);
	InstitutionAuthor getById(int topicId,int authorId);
