		...
		<div class="info-header">
			<div class="name-show">
				<h2>
					${name}
					<c:if test="${isSelf }">
						<a class="edit-personal" href="<dhome:url value='/people/${domain}/admin/personal'/>"><i class="icon-edit icon-white"></i><fmt:message key="personal.common.editSelf"/></a>	
					</c:if>
				</h2>
				...
				<p class="self-intro" style="margin-top:5px;">${detailUser.introduction }</p>
