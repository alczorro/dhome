...
(function () {
     ...
     */
	window.UEDITOR_HOME_URL = getContextPath()+"/resources/third-party/ueditor/";
    var URL;
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:getContextPath()+"/system/img?func=uploadImg"             //图片上传提交地址
        ...
        //附件上传配置区
        ,fileUrl:getContextPath()+"/system/file?func=uploadFile"             //附件上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:getContextPath()+"/system/img?func=manageImg"        			  //图片在线管理的处理地址
        ...
        //获取视频数据的地址
        ,getMovieUrl:getContextPath()+"/system/video?func=search"               //视频数据获取地址
        ...
        //]
            ...
            ['fullscreen',  'undo', 'redo', '|',
                ...
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright',
                'imagecenter', '|', 'insertimage', 'insertvideo', 'attachment', 'map',  'insertframe','highlightcode',/*'webapp',*/'|',
                'horizontal', 'date', 'time', 'spechars'/*,'snapscreen', 'wordimage'*/, '|',
                'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'searchreplace']
        ]
        ...
        ,maximumWords:40000       //允许的最大字符数
        //,wordCountMsg:'当前已输入 {#count} 个字符，您还可以输入{#leave} 个字符 '   //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数
        ,wordOverFlowMsg:'<span style="color:red;">你输入的字符个数已经超出最大允许值！</span>'    //超出字数限制提示
