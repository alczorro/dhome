					...
					<div class="form-horizontal">
						<div class="control-group">
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls padding">
							    <c:if test="${academic.endYear==3000}">至今</c:if>
			       				<c:if test="${academic.endYear!=3000}">
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls padding">
			         			<a class="btn btn-primary" href="<dhome:url value="/people/${domain}/admin/academic/update/${academic.id }?returnPage=${returnPage }"/>">编辑</a>
								<a id="deleteAcademic" class="btn" href="<dhome:url value="/people/${domain }/admin/academic/delete?acmId[]=${academic.id }&page=${returnPage }"/>">删除</a>
