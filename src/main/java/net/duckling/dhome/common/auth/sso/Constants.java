...
public final class Constants {
	...
	public static final String CURRENT_HOME = "current.home";
	public static final String CURRENT_USER_DOMAIN = "domain";
	public static final String TAGET_HOME = "target.home";
