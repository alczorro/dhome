...
<head>
	...
	<link href="<dhome:url value='/resources/css/theme_s_fashion.min.css'/>" rel="stylesheet" type="text/css"/>
</head>

<body class="dHome-body fashion" data-offset="50" data-target=".subnav"
	data-spy="scroll">
	...
	<div id="homepagebody" class="container fashion-skin">
