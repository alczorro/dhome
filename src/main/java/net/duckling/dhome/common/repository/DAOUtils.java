...
/**
 * Simulation ORM-Mapping 
 * 如果不是遵守约定的bean 请勿用词方法 约定命名规则 javaBean DB
 * -------------------------- 
 * someClass some_class(对象名，表名) 
 * id		 id （主键） 
 * someField some_field 
 * -------------- 
 * boolean值不允许参加查询，忽略，如果需要请用extendSQL附加，因为布尔值没有null
...
public class DAOUtils<T> {
     ...
     * @return xx_xx
     * */
    private String getDBField(String objField,String outter) {
        StringBuilder sb = new StringBuilder(outter);
