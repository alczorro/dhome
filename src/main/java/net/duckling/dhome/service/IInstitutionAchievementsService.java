...
public interface IInstitutionAchievementsService {
	
	PageResult<InstitutionAchievements> getList(int insId, int page);
...
//	
	...
	//根据作者查询论文
	 List<InstitutionPaper> getPapersByAuthor(List<InstitutionAuthor> authors,int startYear,int endYear);
