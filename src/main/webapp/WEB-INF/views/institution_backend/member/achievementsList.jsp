		...
		<div class="container">
			...
			<div class="ins_backend_rightContent">
				<ul class="nav nav-tabs">
					<jsp:include page="../../commonMemberBackend.jsp"><jsp:param name="activeItem" value="achieve" /> </jsp:include>
<!-- 				     <li class="search"> -->
...
<!-- 				    </li> -->
			...
			<h4 class="detail" style="margin-top:20px;">
				...
				<span style="float:right; margin-bottom:5px;">
					<input type="button" id="createBtn" value=" +新增绩效考核表 " class="btn btn-mini btn-success"/>
				</span>
				绩效考核表
<!-- 				<span style="margin-left:200px; margin-bottom:5px;"> -->
<!-- 					<input type="button" id="templBtn" value=" +更换绩效考核表模板 " class="btn btn-mini btn-success"/> -->
<!-- 				</span> -->
			</h4>
				...
				<ul class="applyList">
					...
					<c:forEach items="${page.datas }" var="data">
						<li>
		    				...
		    				<a class="aliasLink" target='_blank' href="/institution/${domain}/backend/achievements/details/${data.id}/1">
				    				${data.title }
				    				</a>
				    		</span>
				    		<span class="time">
				    		...
				    		<span class="position">
								<a data-toggle="modal" href="/institution/${domain}/backend/achievements/delete/${data.id }" class="deleteJob float-right popup-edit btn btn-mini"><i class="icon-trash"></i>&nbsp;删除</a>
								<a href="/institution/${domain}/backend/achievements/details/${data.id}/1" class="float-right btn btn-mini btn-info" style="margin-right:5px"><i class="icon-eye-open icon-white"></i>&nbsp;查看</a>
							</span>
						</li> 
					</c:forEach>
				</ul>
	...
	<script>
		$(document).ready(function(){
			$("#createBtn").click(function(){
				window.location="/institution/${domain}/backend/achievements/creat";
			});
			$("#templBtn").click(function(){
				window.location="/institution/${domain}/backend/achievements/addTempl";
			});
