...
public interface IInstitutionPaperSearchDAO {
	...
	int getPaperCountByInit(int institutionId,String userName);
	List<InstitutionPaper> getPapersByInit(int institutionId,int offset, int size,String userName);
	void insertPaper(String[] paperId,int userId);
	void deletePaperUser(String[] paperId,int userId);
