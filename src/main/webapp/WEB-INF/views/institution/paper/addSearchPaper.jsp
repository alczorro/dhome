...
<%-- 		   <span class="config-link active"><a href="<dhome:url value="/people/${domain}/admin/p/index"/>"><fmt:message key='admin.common.link.content'/></a></span> --%>
<%-- 			<span class="config-link"><a href="<dhome:url value="/people/${domain}/admin/custom/theme"/>"><fmt:message key='admin.common.link.theme'/></a></span> --%>
<%-- 			<span class="config-link"><a href="<dhome:url value="/people/${domain}/admin/domain"/>"><fmt:message key='admin.common.link.setting'/></a></span> --%>
<%-- 			<span class="config-link"><a href="<dhome:url value='/people/${domain}/admin/personal/baseinfo'/>"><fmt:message key='admin.common.link.personInfo'/></a></span> --%>
<%-- 			<span><a class='btn btn-warning' href="<dhome:url value="/people/${domain}"/>"><fmt:message key='admin.common.link.viewMyHome'/></a></span> --%>
<!-- 		</div> -->
		    ...
		    <div id="mainSpan">
			    ...
			    <div class="page-container">
				    ...
				    <ul class="nav nav-tabs">
						<li>
						    <a href="<dhome:url value='/people/${domain}/admin/commonPaper'/>"><i class="dicon-return">&nbsp;</i></a>
						</li>
					   	<li class="active">
