			...
			if (this.showDataLabels && V[Q][2] * 100 >= this.dataLabelThreshold) {
				...
				if (this.dataLabels == "label") {
					...
					if(this.dataLabels == "both"){
						S = this.dataLabelFormatString || "%d(%d%%)";
						C = e.jqplot.sprintf(S,this.data[Q][1], V[Q][2] * 100)
					}else{
				...
				var D = e(
						'<span class="jqplot-donut-series jqplot-data-label" style="position:absolute;font-size:12px;">'
								+ C + "</span>").insertBefore(
						P.eventCanvas._elem);
				F -= D.width() / 2;
				E -= D.height() / 2;
