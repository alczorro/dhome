...
<!-- 				    </li> -->
				...
				<h4 class="detail"  style="margin-top:20px;">绩效考核表</h4>
...
<!-- 	       		</div> -->
	       		...
	       		<div class="control-group">
	       			...
	       			<div class="controls">
	         			...
	         			<a class="btn btn-link" href="/institution/${domain}/backend/achievements/list/1">取消</a>
	       			</div>
	       		</div>
			</form>
...
// 					data +='&studentId='+tid;
					...
					$.post('/institution/${domain}/backend/achievements/save',data).done(function(data){ 
						if(data.success){
							window.location.href='/institution/${domain}/backend/achievements/list/1';
						}else{
							alert(data.desc);
						}
					});
