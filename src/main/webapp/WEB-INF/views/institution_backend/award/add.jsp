...
<jsp:include page="../leftMenu.jsp"></jsp:include>
		<div class="ins_backend_rightContent">
			<ul class="nav nav-tabs">
				<jsp:include page="../../commonAwardBackend.jsp"><jsp:param name="activeItem" value="modifyAward" /> </jsp:include>
			</ul>
				...
				<div class="control-group">
	       		...
	       		<div class="control-group">
	       			...
	       			<div class="controls">
						...
						<p class="notFind">没有找到您要选择的获奖人？点击这里<a id="addAuthor">添加获奖人</a></p>
	       		...
	       		<div class="control-group">
	       			...
	       			<div class="controls">
	         			...
	         			<a class="btn btn-link" href="<dhome:url value="/institution/${domain }/backend/award/list/1"/>">取消</a>
	       			</div>
	       		</div>
		...
		<div class="modal-header">
           ...
           <h3>添加获奖人</h3>
			...
			<div class="modal-body">
        		...
        		<div class="control-group">
         			<label class="control-label">获奖人排序：</label>
          			<div class="controls">
          				第
	...
	<script>
		$(document).ready(function(){
			...
			$('#authorSaveBtn').on('click',function(){
				...
				$.post('<dhome:url value="/institution/${domain}/backend/award/author/create"/>',$('#addAuthorForm').serialize()).done(function(data){
					if(data.success){
		   ...
		   //提交论文
			$('#awardSaveBtn').on('click',function(){
				if($('#editForm').valid()){
					...
					if(author.data.length!=0){
						...
						$("#authorError").html("").append("获奖人不允许为空");
						return;
					}
					...
					$.post('<dhome:url value="/institution/${domain}/backend/award/submit"/>',data).done(function(data){ 
						if(data.success){
							window.location.href='<dhome:url value="/institution/${domain}/backend/award/list/1"/>'
						}else{
							alert(data.desc);
						}
					});
			...
			if('${op}'=='update'){
				//渲染获奖人
				$.get('<dhome:url value="/institution/${domain}/backend/award/authors/${award.id}"/>').done(function(data){
					if(data.success){
