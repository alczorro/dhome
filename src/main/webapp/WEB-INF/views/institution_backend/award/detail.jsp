			...
			<div class="form-horizontal">
				<%-- <div class="control-group">
	       		...
	       		<div class="control-group">
	       			...
	       			<div class="controls padding">
	         			<a class="btn btn-primary" href="<dhome:url value="/institution/${domain}/backend/award/update/${award.id }?returnPage=${returnPage }"/>">编辑</a>
						<a id="deleteaward" class="btn" data-url="<dhome:url value="/institution/${domain }/backend/award/delete?awardId[]=${award.id }"/>">删除</a>
			...
			$('#deleteaward').on('click',function(){
				if(confirm("奖励删除以后不可恢复，确认删除吗？")){
					$.get($(this).data('url')).done(function(data){
						if(data.success){
							window.location.href='<dhome:url value="/institution/${domain}/backend/award/list/${returnPage }"/>'
						}else{
							alert(data.desc);
						}
					});
