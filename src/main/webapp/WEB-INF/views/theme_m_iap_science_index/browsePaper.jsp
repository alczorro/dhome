...
<head>
	...
	<link href="<dhome:url value='/resources/css/theme_m_iap_science.css'/>" rel="stylesheet" type="text/css"/>
</head>

<body class="dHome-body iap_science" data-offset="50" data-target=".subnav" data-spy="scroll">
	<jsp:include page="../commonBanner.jsp"></jsp:include>
	<div class="container iap-science-skin" id="homepagebody">
		<div class="row-fluid center">
		    ...
		    <div id="mainSpan">
			    <div class="page-header">
			    	<h4><fmt:message key="common.paper.title"/>
			    		<c:if test="${isSelf }">
