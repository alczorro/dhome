 ...
 * choose the license that best suits your project and use it accordingly.
 * 
 * jsDate borrows many concepts and ideas from the Date Instance Methods by Ken
 * Snyder along with some parts of Ken's actual code.
 * 
 * Ken's origianl Date Instance Methods and copyright notice:
 * 
 * Ken Snyder (ken d snyder at gmail dot com) 2008-09-10 version 2.0.2
 * (http://kendsnyder.com/sandbox/date/) Creative Commons Attribution License
 * 3.0 (http://creativecommons.org/licenses/by/3.0/)
 * 
 * jqplotToImage function based on Larry Siden's export-jqplot-to-png.js. Larry
 * has generously given permission to adapt his code for inclusion into jqPlot.
 * 
