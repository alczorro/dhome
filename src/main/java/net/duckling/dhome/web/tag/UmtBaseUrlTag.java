 ...
 * @since 2012-9-28
 */
public class UmtBaseUrlTag extends TagSupport{
	private static final long serialVersionUID = 834487623871L;
	private static final Logger LOG = Logger.getLogger(UmtBaseUrlTag.class);
	@Override
	public int doStartTag() throws JspException {
		JspWriter out = this.pageContext.getOut();
		try {
			init();
			out.print(appConfig.getUmtBaseURL());
