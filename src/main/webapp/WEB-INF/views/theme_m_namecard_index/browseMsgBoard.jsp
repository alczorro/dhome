...
<head>
	...
	<link href="<dhome:url value='/resources/css/theme_m_namecard.min.css'/>" rel="stylesheet" type="text/css"/>
</head>

<body class="dHome-body gray namecard" data-offset="50" data-target=".subnav" data-spy="scroll">
	<jsp:include page="../commonBanner.jsp"></jsp:include>
	<div class="container namecard-skin" id="homepagebody">
											    	...
											    	<div class="right">
										    			...
										    			<c:if test="${msg.comment.uid==currentUser.id }">
										    			 	<li class="msgReplyArea">
											    			 	...
											    			 	<span style="color:red"><fmt:message key='msg.validate.frequent'/></span>
											    			</li>
										    			</c:if>
									    			 </ul>
									    			 </c:if>
