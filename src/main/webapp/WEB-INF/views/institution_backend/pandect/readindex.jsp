...
<script>
	...
	function selectYear(data){
		...
		$.get('<dhome:url value="/institution/${domain}/backend/readOnly/count/"/>'+deptmentId+'/'+data).done(function(result){
			if(result.success){
	...
	function selectDept(id,name){
		...
		$.get('<dhome:url value="/institution/${domain}/backend/readOnly/count/"/>'+deptmentId+'/'+year).done(function(result){
			if(result.success){
				renderCount(result.data);
			}
		});
	...
	function selectMemberDept(id,name){
		...
		$.get('<dhome:url value="/institution/${domain}/backend/readOnly/member/"/>'+memberOp+'/'+id).done(function(result){
			if(result.success){
...
/* 	 $("#papers-year-jq").hide();
	...
	$("a#member-degree").click(function(){
		memberOp ="degree";
		$.get('<dhome:url value="/institution/${domain}/backend/readOnly/member/degree/"/>'+memberDpetId).done(function(result){
			if(result.success){
	...
	$("a#member-title").click(function(){
		memberOp ="title";
		$.get('<dhome:url value="/institution/${domain}/backend/readOnly/member/title/"/>'+memberDpetId).done(function(result){
			if(result.success){
	...
	$("a#member-age").click(function(){
		memberOp ="age";
		$.get('<dhome:url value="/institution/${domain}/backend/readOnly/member/age/"/>'+memberDpetId).done(function(result){
			if(result.success){
