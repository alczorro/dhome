		...
		<div class="row-fluid mini-layout center p-top">
			...
			<div class="span9 left-b">
				<div class="ins_backend_rightContent">
						<jsp:include page="../../commonTreatise.jsp"><jsp:param name="activeItem" value="modifyTreatise" /> </jsp:include>
					<form id="editForm" class="form-horizontal">
						...
						<%-- <div class="control-group">
			       			...
			       			<div class="controls">
			         			<input type="text" name="publisher" id="publisher" value="<c:out value="${treatise.position }"/>" maxlength="250"/>
								<span id="publisher_error_place" class="error"></span>
			       			</div>
			       		</div> --%>
			       		<div class="control-group">
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls">
			         			...
			         			<a class="btn btn-link" href="<dhome:url value="/people/${domain }/admin/treatise/list/1"/>">取消</a>
			       			</div>
			       		</div>
	...
	<script>
		$(document).ready(function(){
			...
			$('#authorSaveBtn').on('click',function(){
				...
				$.post('<dhome:url value="/people/${domain}/admin/treatise/author/create"/>',$('#addAuthorForm').serialize()).done(function(data){
					if(data.success){
		   ...
		   //提交论著
			$('#treatiseSaveBtn').on('click',function(){
				if($('#editForm').valid()){
					...
					$.post('<dhome:url value="/people/${domain}/admin/treatise/submit"/>',data).done(function(data){ 
						if(data.success){
							window.location.href='<dhome:url value="/people/${domain}/admin/treatise/list/1"/>'
						}else{
							alert(data.desc);
						}
					});
