...
<head>
	...
	<link href="<dhome:url value='/resources/css/theme_m_tradition.min.css'/>" rel="stylesheet" type="text/css"/>
</head>

<body class="dHome-body gray tradition" data-offset="50" data-target=".subnav"
	data-spy="scroll">
	...
	<div class="container tradition-skin" id="homepagebody">
...
<%-- 														<a data-paper-id="${data.id }" class="showSummary">查看摘要</a> --%>
						...
						<c:otherwise>
						<div class="otherpage">
							<div class="page-header"></div><h2 class="inner">${page.title }</h2>
							<c:if test="${isSelf }">
								<a class="edit-personal inner" href="<dhome:url value="/people/${domain}/admin/p/${page.keyWord }?func=edit&pid=${page.id }"/>"><fmt:message key="common.edit"/></a>
							</c:if>
