		...
		<div class="container">
			...
			<div class="ins_backend_rightContent">
				<ul class="nav nav-tabs">
					<jsp:include page="../../commonTreatiseBackend.jsp"><jsp:param name="activeItem" value="addTreatise" /> </jsp:include>
				</ul>
...
<script type="text/javascript">
	$(document).ready(function(){
	    var uploader = new qq.FileUploader({
	        ...
	        action: "<dhome:url value='/institution/${domain}/backend/treatise?func=uploadExceltex'/>",
