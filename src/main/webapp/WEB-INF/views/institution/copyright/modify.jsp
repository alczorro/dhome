	...
	<div class="container canedit">
		<div class="row-fluid mini-layout center p-top">
			...
			<div class="span9 left-b">
				<div class="ins_backend_rightContent">
					<jsp:include page="../../commonCopyright.jsp"><jsp:param name="activeItem" value="modifyCopyright" /> </jsp:include>
					<form id="editForm" class="form-horizontal" method="post" action="<dhome:url value="/people/admin/copyright/creat"/>">
						...
						<div class="control-group">
			       			...
			       			<div class="controls">
			         			<input type="text" name="name" id="name" value="<c:out value="${copyright.name }"/>" maxlength="250"/>
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls">
								...
								<table id="authorTable" class="table table-bordered fiveCol" style="margin-left:0">
		...
		<%-- 						<a id="fileRemove" style="display:${empty paper||paper.clbId==0?'none':'inline' }">删除</a> --%>
			       		...
			       		<div class="control-group">
			       			...
			       			<div class="controls">
			       				<a class="btn" href="<dhome:url value="/people/${domain }/admin/copyright/list/1"/>">取消</a>
...
// 				$data.authorTeacher=$('#editAuthorTeacherL input[type=checkbox]').is(':checked');
			...
			$('#authorSaveBtn').on('click',function(){
				...
				$.post('<dhome:url value="/people/${domain}/admin/copyright/author/create"/>',$('#addAuthorForm').serialize()).done(function(data){
					if(data.success){
...
// 							data+='&authorType[]='+auth.authorType;
					...
					$.ajax({
	 					  type: 'POST',
	 					  url: '<dhome:url value="/people/${domain}/admin/copyright/submit"/>',
	 					  data: data,
	 					  success: function(data){window.location.href='<dhome:url value="/people/${domain}/admin/copyright/list/${empty returnPage?1:returnPage}"/>'},
...
// 					});
			...
			new qq.FileUploader({
				...
				action :'<dhome:url value="/people/${domain}/admin/copyright/upload"/>',
