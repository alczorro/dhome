...
<body class="dHome-body institu" data-offset="50" data-target=".subnav" data-spy="scroll">
	...
	<div class="container">
		...
		<div class="ins_backend_rightContent">
			...
			<jsp:include page="../../commonTopicBackend.jsp"><jsp:param name="activeItem" value="modifyTopic" /> </jsp:include>
<!-- 				<li>&nbsp;&nbsp;&nbsp;</li> -->
<!-- 				<li> -->
<%-- 				    <a href="<dhome:url value="/institution/${domain }/backend/topic/list/1"/>">课题 ${topicCount }</a> --%>
<!-- 				</li> -->
<!-- 				<li class="active"> -->
<!-- 				    <a href="#"> -->
<%-- 					    <c:choose> --%>
...
<!-- 			    </li> -->
			...
			<form id="editForm" class="form-horizontal" method="post" action="<dhome:url value="/institution/backend/topic/creat"/>">
				...
				<div class="control-group">
	       		...
	       		<div class="control-group">
	       			...
	       			<div class="controls">
	         			...
	         			<a class="btn btn-link" href="<dhome:url value="/institution/${domain }/backend/topic/list/1"/>">取消</a>
	       			</div>
	       		</div>
			</form>
		</div>	
...
// 				$.ajax({
// 					  type: 'POST',
// 					  url: '<dhome:url value="/institution/${domain}/backend/topic/submit"/>',
// 					  data: $('form').serialize(),
// 					  success: function(data){window.location.href='<dhome:url value="/institution/${domain}/backend/topic/list/1"/>'},
...
// 					return;
// 				}
				$.post('<dhome:url value="/institution/${domain}/backend/topic/author/create"/>',$('#addAuthorForm').serialize()).done(function(data){
					if(data.success){
			...
			$('#topicSaveBtn').on('click',function(){
				if($('#editForm').valid()){
					...
					$.ajax({
	 					  ...
	 					  url: '<dhome:url value="/institution/${domain}/backend/topic/submit"/>',
	 					  data: data,
	 					  success: function(data){window.location.href='<dhome:url value="/institution/${domain}/backend/topic/list/${empty returnPage?1:returnPage}"/>'},
